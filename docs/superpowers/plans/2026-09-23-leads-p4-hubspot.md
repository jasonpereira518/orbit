...
4. **Engagements (`syncEvents`) are deferred.** The spec calls them optional; P4 reads people only. The manifest keeps the capability listed but the sync never reads it.
