...
const ALLOWLIST: Record<string, string> = {
  ...
  "src/lib/ai.ts:570": OPENROUTER_ROUTED_AWAY + " (completeJson's gemini arm; openai and " +
  ...
  "src/lib/ai.ts:698": OPENROUTER_ROUTED_AWAY + " (completeMultimodalJsonInner's gemini arm; " +
    "see ai.ts:570.)",
  ...
  "src/lib/ai.ts:972": "transcription() (ai-access.ts) only ever grants \"openai\" or " +
  ...
  "src/lib/ai.ts:2153": OPENROUTER_ROUTED_AWAY + " (streamText's gemini arm; see ai.ts:570.)",
