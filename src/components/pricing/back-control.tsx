...
export function BackControl() {
  ...
  return (
    <button
      ...
      className="group -ml-2 inline-flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm text-[#9aada8] transition-colors hover:text-[#e8f3f1] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#f2c14e]"
    >
      <ArrowLeft
