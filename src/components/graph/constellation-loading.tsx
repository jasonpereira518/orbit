 ...
 * a visible jump at the end of every load. The stage's offset is the correct one (now
 * 18.5rem): the app's floating bottom nav is a fixed ~4rem pill below `md`, and the shorter
 * box ran the canvas and its
