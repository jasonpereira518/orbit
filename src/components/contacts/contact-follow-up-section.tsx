      ...
      <div className="space-y-4">
        ...
        {draft ? (
          <div className="space-y-3">
            ...
            />
            <div className="sticky bottom-[calc(9.5rem+env(safe-area-inset-bottom))] z-10 -mx-1 flex flex-wrap gap-2 border-t border-border/50 bg-card/95 px-1 py-2 backdrop-blur sm:static sm:mx-0 sm:border-0 sm:bg-transparent sm:p-0 sm:backdrop-blur-none">
