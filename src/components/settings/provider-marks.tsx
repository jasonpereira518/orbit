 ...
 *
 * Google's four are its own published values — #EA4335, #4285F4, #FBBC05, #34A853, the same
 * blue `brand-colors.ts` already uses for the company — not the Material-palette near-misses
 * an icon pack ships. Orbit's Google consent screen is going through verification, and a mark
...
/** OpenAI's own 2025 "blossom" symbol, in use since Feb 2025 (openai.com/brand). */
...
/**
 * OpenRouter's mark, simple-icons' recorded path (fetched, not drawn from memory — the
 * Google mark this file once carried was an icons8 approximation and had to be replaced).
 * In `currentColor`: OpenRouter publishes it as a monochrome glyph, so it inherits the text
 * colour and works on both themes, like the OpenAI and ChatGPT marks above.
 */
export function OpenRouterMark({ className }: MarkProps) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden className={className}>
      <path fill="currentColor" d="M16.778 1.844v1.919q-.569-.026-1.138-.032-.708-.008-1.415.037c-1.93.126-4.023.728-6.149 2.237-2.911 2.066-2.731 1.95-4.14 2.75-.396.223-1.342.574-2.185.798-.841.225-1.753.333-1.751.333v4.229s.768.108 1.61.333c.842.224 1.789.575 2.185.799 1.41.798 1.228.683 4.14 2.75 2.126 1.509 4.22 2.11 6.148 2.236.88.058 1.716.041 2.555.005v1.918l7.222-4.168-7.222-4.17v2.176c-.86.038-1.611.065-2.278.021-1.364-.09-2.417-.357-3.979-1.465-2.244-1.593-2.866-2.027-3.68-2.508.889-.518 1.449-.906 3.822-2.59 1.56-1.109 2.614-1.377 3.978-1.466.667-.044 1.418-.017 2.278.02v2.176L24 6.014Z" />
    </svg>
  );
}
