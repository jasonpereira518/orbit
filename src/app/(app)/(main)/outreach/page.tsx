  ...
  if (!canUseOutreach) {
    return (
      <LockedFeature
        ...
        note="Included in Orbit Pro and Orbit Lifetime, both of which send email and SMS on Orbit's credits. On Orbit Lifetime you supply your own Apollo key for prospect search."
      />
    );
  }
