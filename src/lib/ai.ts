...
type ChatPromptArgs = {
  ...
  calendarContext: Parameters<typeof chatWithNetwork>[9];
};
...
export async function chatWithNetworkStream(
  ...
  calendarContext: Parameters<typeof chatWithNetwork>[9] = null
): Promise<SplitResult> {
