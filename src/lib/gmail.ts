...
/**
 * These three are provider-agnostic (they operate on generic from/subject/snippet
 ...
 */
export { parseFromHeader, firmFromEmail, looksLikeRecruiter } from "@/lib/recruiter-detect";
